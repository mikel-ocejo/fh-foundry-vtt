...
export const displayChatActionButtons = function(message, html, data) {
  const chatCard = html.find(".fanhunter3e.chat-card");
...
export const addChatMessageContextOptions = function(html, options) {
  ...
  options.push(
    {
      name: game.i18n.localize("fanhunter3e.ChatContextDamage"),
      icon: '<i class="fas fa-user-minus"></i>',
      condition: canApply,
      callback: li => applyChatCardDamage(li, 1)
    },
    {
      name: game.i18n.localize("fanhunter3e.ChatContextHealing"),
      icon: '<i class="fas fa-user-plus"></i>',
      condition: canApply,
      callback: li => applyChatCardDamage(li, -1)
    },
    {
      name: game.i18n.localize("fanhunter3e.ChatContextDoubleDamage"),
      icon: '<i class="fas fa-user-injured"></i>',
      condition: canApply,
      callback: li => applyChatCardDamage(li, 2)
    },
    {
      name: game.i18n.localize("fanhunter3e.ChatContextHalfDamage"),

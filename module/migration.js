...
export const migrateWorld = async function() {
  ...
  game.settings.set("fanhunter3e", "systemMigrationVersion", game.system.data.version);
...
function cleanActorData(actorData) {
  ...
  // Scrub system flags
  const allowedFlags = CONFIG.FANHUNTER.allowedActorFlags.reduce((obj, f) => {
    obj[f] = null;
    return obj;
  }, {});
  if ( actorData.flags.fanhunter3e ) {
    actorData.flags.fanhunter3e = filterObject(actorData.flags.fanhunter3e, allowedFlags);
  }

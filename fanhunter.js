...
// Import Modules
import { FANHUNTER } from "./module/config.js";
...
Hooks.once("init", function() {
  console.log(`Fanhunter | Empezando el sistema de Fanhunter\n${FANHUNTER.ASCII}`);
...
Hooks.once("setup", function() {
  ...
  for ( let o of toLocalize ) {
    const localized = Object.entries(CONFIG.FANHUNTER[o]).map(e => {
      return [e[0], game.i18n.localize(e[1])];
    });
    if ( !noSort.includes(o) ) localized.sort((a, b) => a[1].localeCompare(b[1]));
    CONFIG.FANHUNTER[o] = localized.reduce((obj, e) => {
      obj[e[0]] = e[1];
      return obj;
    }, {});
  }
